  ...
  <footer class="mt-auto">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 py-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-sm text-cream-muted">
      ...
      <div class="flex items-center gap-6">
        ...
        <a href="https://x.com/ChainInsightsAI" target="_blank" rel="noopener" class="hover:text-gold transition-colors">
          X / Twitter
        </a>
        <a href="https://github.com/chainswarm" target="_blank" rel="noopener" class="hover:text-gold transition-colors">
          GitHub
        </a>
      </div>
    </div>
